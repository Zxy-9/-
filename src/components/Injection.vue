<template>
    <div class="com-container">
        <div class="com-chart" ref="injection_ref"></div>
    </div>
</template>
...
<script>
    export default {
        ...
        methods:{
            initChart(){
                this.chartInstance=this.$echarts.init(this.$refs.injection_ref,'chalk')
            ...
            screenAdapter(){
                const titleFontSize=this.$refs.injection_ref.offsetWidth/100*2.8
                const adapterOption = {
                    title:{
                        textStyle:{
